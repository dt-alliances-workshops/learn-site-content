...
![WelcometoDT](img/aws-lab0-immersion-day/WelcometoDT.png)
...
![event engine initial screen](img/aws-lab0-immersion-day/event-engine-initial-screen.png)

3 . Click on `Email One Time Password (OTP)`

![one time password](img/aws-lab0-immersion-day/one-time-password.png)

4 . Enter your email address

![send passcode](img/aws-lab0-immersion-day/send-passcode.png)

5 . Enter the Passcode from you received in your email.

![enter passcode](img/aws-lab0-immersion-day/enter-passcode.png)

6 . Once on the `Team dashboard` page, click the `AWS console` button that opens a popup.  

![aws event engine](img/aws-lab0-immersion-day/aws-event-engine.png)

7 . On the popup, click on `Open AWS console` button which opens the AWS portal.

![aws event engine popup](img/aws-lab0-immersion-day/aws-event-engine-popup.png)

8 . One the new browser tab, you should see the AWS portal. 

![setup aws portal](img/aws-lab0-immersion-day/setup-aws-portal.png)
...
![lab2 change region](img/aws-lab0-immersion-day/lab2-change-region.png)
-->
...
![setup cloud shell icon](img/aws-lab0-immersion-day/setup-cloud-shell-icon.png)

This may open up a slash page. 

![lab2 cloudshell splash page](img/aws-lab0-immersion-day/lab2-cloudshell-splash-page.png)
...
![setup cloud shell](img/aws-lab0-immersion-day/setup-cloud-shell.png)
...
![dt provision dashboard list](img/aws-lab0-immersion-day/dt-provision-dashboard-list.png)
...
![dt copy command](img/aws-lab0-immersion-day/dt-copy-command.png)
...
![CFTCreateCompeleteMonoAG](img/aws-lab0-immersion-day/CFTCreateCompeleteMonoAG.png)
