...
![lambdaServices](img/aws-lab12-serverless-observability/lambdaServices.png)

Navigate on the left side menu to `Settings` then `Start Installation` and select `AWS Lambda`

![deployLambda](img/aws-lab12-serverless-observability/deployLambda.png)
...
![deployLambdaSettings](img/aws-lab12-serverless-observability/deployLambdaSettings.png)
...
![awsLambdaVar](img/aws-lab12-serverless-observability/awsLambdaVar.png)
...
![cwLambdaLink](img/aws-lab12-serverless-observability/cwLambdaLink.png)
...
![serviceFlow](img/aws-lab12-serverless-observability/serviceFlow.png)
...
![frontendServiceFlow](img/aws-lab12-serverless-observability/frontendServiceFlow.png)
...
![catalogdServiceFlow](img/aws-lab12-serverless-observability/catalogdServiceFlow.png)
...
![filter](img/aws-lab12-serverless-observability/filter.png)
...
![feDistributedTracing](img/aws-lab12-serverless-observability/feDistributedTracing.png)

Now click on the frist instance on the resulting page name `/catalog/1html`

![catalogDTracing](img/aws-lab12-serverless-observability/catalogDTracing.png)
...
![trace](img/aws-lab12-serverless-observability/trace.png)
...
![lambdaDT](img/aws-lab12-serverless-observability/lambdaDT.png)
...
![otelDT](img/aws-lab12-serverless-observability/otelDT.png)
