...
2.  Click on Start.
    ![setup azure](img/azure-aks-levelup-lab0/setup-azure.png)
3. Use a ***personal email address*** to signin or create a new Microsoft account email.
    ![azure pass signin](img/azure-aks-levelup-lab0/azure-pass-signin.png)
    !!! warning
    ...
    ![setup ms account](img/azure-aks-levelup-lab0/setup-ms-account.png) <br>   
...
4.  Confirm the email address you want to use for your Azure pass subscription and "promo" code provided to allow for the Azure subscription to be setup.
    ![azure pass emailconfirm](img/azure-aks-levelup-lab0/azure-pass-emailconfirm.png)
    !!! tip
...
1) Open up browser and go to Azure Portal - [https://portal.azure.com/ ](https://portal.azure.com/){target="_blank"}
    - Search for Marketplace from the top search bar
        ![az marketplace](img/azure-aks-levelup-lab0/az-marketplace.png)
    ...
    - Once in the Azure Marketplace, search for `Azure Native Dynatrace Service` click on tile when the search displays the results.
        ![ands](img/azure-aks-levelup-lab0/ands.png)
    - From the drop-down under plan, select `Dynatrace for Azure Trial` and click on subscribe
        ![ands subscribe](img/azure-aks-levelup-lab0/ands-subscribe.png)        

    - Click on "Create" a new Dynatrace environment
        ![ands create](img/azure-aks-levelup-lab0/ands-create.png)
    ...
    - On the create Dynatrace environment screen (Basic's)
        ...
        - Click on "Review + Create" button
            ![ands create basics 1](img/azure-aks-levelup-lab0/ands-create-basics-1.png)
        - On the next screen click on "Create" button
            ![Lab0 Step4 ands validate](img/azure-aks-levelup-lab0/Lab0-Step4-ands-validate.png)
        - It will take 3-5 minutes for the deployment to complete.  Once the deployment completes successfully, your screen should reflect as below.  Click on `Go to resource` button
            ![ands create complete](img/azure-aks-levelup-lab0/ands-create-complete.png)
...
1. Click on the Cloud Shell button
    ![setup azure shell open](img/azure-aks-levelup-lab0/setup-azure-shell-open.png)

    !!! tip
    Choose bash as your shell.  

<!--
    ![setup azure shell bash](img/azure-aks-levelup-lab0/setup-azure-shell-bash.png)

    <br>!!! tip
    If you get the prompt below, choose `Azure Pass - Sponsorship` and then click the `Create Storage` button.

    
    ![setup azure shell storage](img/azure-aks-levelup-lab0/setup-azure-shell-storage.png)
    ...
    ![setup azure shell prompt](img/azure-aks-levelup-lab0/setup-azure-shell-prompt.png)

    4. Make a dedicated Azure shell Browser tab by clicking this new tab icon.
    ![setup azure shell newtab](img/azure-aks-levelup-lab0/setup-azure-shell-newtab.png)
...
- You should see an output similar to the one below 
 ![pre requisites azure cli gitcloneoutput](img/azure-aks-levelup-lab0/pre-requisites-azure-cli-gitcloneoutput.png)
...
1. Open up browser and go to Azure Portal - [https://portal.azure.com/ ](https://portal.azure.com/){target="_blank"}
    - Search for Dynatrace azure resource `dt-trial` from the top search bar     
        ![Lab0 Step4 ands search](img/azure-aks-levelup-lab0/Lab0-Step4-ands-search.png)
    - Click on Go to Dynatrace Link 
        ![Lab0 Step5 ands gotodt](img/azure-aks-levelup-lab0/Lab0-Step5-ands-gotodt.png)

1. Login to Dynatrace
    !!! tip

        💡To login to Dynatrace you use "Sign in with Microsoft" option; 
        ![lab0 loginwithMS](img/azure-aks-levelup-lab0/lab0-loginwithMS.png)

        Input your email address you're currently logged in with.

        ![lab0 loginwithMS 1](img/azure-aks-levelup-lab0/lab0-loginwithMS-1.png)
...
1. On the Left menu, you'll notice a banner to access the new UI that was introduced with Grail.  
  - Click on `Take a look` button to access the new UI.
    ![lab0 newUI access banner](img/azure-aks-levelup-lab0/lab0-newUI-access-banner.png)
  - Click on `Tru the latest Dynatrace`
    ![lab0 newUI try latest dt](img/azure-aks-levelup-lab0/lab0-newUI-try-latest-dt.png)
  - Click on `Get started`

1.  You are now accessing the new UI for Grail.
    ![lab0 newUI main](img/azure-aks-levelup-lab0/lab0-newUI-main.png)
...
1. From the Left menu, click Apps -> Choose the `Access Tokens` app. 
    ...
    ![dt access token](img/azure-aks-levelup-lab0/dt-access-token.png)
...
1. Since this token is only shown once please save it somewhere so that you can use it future lab
    ![dt tokens page save](img/azure-aks-levelup-lab0/dt-tokens-page-save.png)
...
![pre requisites azure portal resources](img/azure-aks-levelup-lab0/pre-requisites-azure-portal-resources.png)
...
![pre requisites azure portal resources resourcelist](img/azure-aks-levelup-lab0/pre-requisites-azure-portal-resources-resourcelist.png)
...
![setup k8](img/azure-aks-levelup-lab0/setup-k8.png)

- Explore the configuration to view the number of nodes and the kubernetes version.

![setup k8 node](img/azure-aks-levelup-lab0/setup-k8-node.png)
</details>
