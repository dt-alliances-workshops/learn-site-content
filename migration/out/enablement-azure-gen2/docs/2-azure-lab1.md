...
Referring to the picture below, here are the components for lab 1.
  ...
  **#3 . Load generator process**
  ...
  A docker processes that sends simulated user traffic to the sample app using [ Jmeter ](https://github.com/dt-orders/load-traffic){target="_blank"} run within a Docker container.  You will not need to interact with this container; it just runs in the background.
    ...
    ![lab1 setup](img/azure-lab1/lab1-setup.png)
...
## Review OneAgent
<!-- Duration: 4 min -->
The host running the sample application was created using scripts to install and run the Sample Application and to install the Dynatrace OneAgent. All these scripts you can review [ here ](https://github.com/dt-alliances-workshops/azure-modernization-dt-orders-setup.git){target="_blank"} within the `provision-scripts` subfolder.
...
!!! tip
    ...
    ![lab1 dynatrace hub](img/azure-lab1/lab1-dynatrace-hub.png)
    ...
    ![lab1 deploy dynatrace](img/azure-lab1/lab1-deploy-dynatrace.png)
    - On the `Download agent` page, pick the platform `Linux` to view the commands will download and run the OneAgent installer.
    ![lab1 download dynatrace](img/azure-lab1/lab1-download-dynatrace.png)
...
![lab1 install dynatrace](img/azure-lab1/lab1-install-dynatrace.png)
...
![lab1 deployment status](img/azure-lab1/lab1-deployment-status.png)
...
1. Get the Public IP to the frontend of the Sample Application
    ...
    ![lab1 azure find vm](img/azure-lab1/lab1-azure-find-vm.png)
...
![lab1 hostlist](img/azure-lab1/lab1-hostlist.png)
- On host page, you will see basic infrastructure information for the host.
    ...
    ![lab1 host view upd](img/azure-lab1/lab1-host-view-upd.png)
    ![lab1 host view proc](img/azure-lab1/lab1-host-view-proc.png)
...
!!! tip
    ...
    ![lab1 smartscape](img/azure-lab1/lab1-smartscape.png)
...
- Let’s see how Dynatrace can visualize these processes using Smartscape.
    ...
    ![lab1 host smartscape](img/azure-lab1/lab1-host-smartscape.png)
...
1. Review the data on the Process screen 
    ...
    - You should be on the process page where you will see information for this process.  Follow the picture below to locate the following:
        ...
        ![lab1 process view](img/azure-lab1/lab1-process-view.png)
            !!! tip
    ...
    📓`Dynatrace and containers`
                ...
                ![lab1 docker monitoring](img/azure-lab1/lab1-docker-monitoring.png)
...
2. Review the data on the Services screen
    - Now Let’s review a specific service.
        ...
        ![lab1 pick service](img/azure-lab1/lab1-pick-service.png)
    - You should be on the service page where you will see information for this specific service.  Follow the picture below to locate the following:
        ...
        ![lab1 service view](img/azure-lab1/lab1-service-view.png)
...
1. Review the Services being monitored. Let’s now take a look at all the services being monitored by clicking on the `Services` left side Dynatrace menu.
    ...
    ![lab1 pick monolith mz](img/azure-lab1/lab1-pick-monolith-mz.png)
    - The filtered list should now look like this:
    ![lab1 trans services](img/azure-lab1/lab1-trans-services.png)
    ...
    ![lab1 top web requests](img/azure-lab1/lab1-top-web-requests.png)
        - On this page you can view the transactions as time-series charts.
            ![lab1 dynamic requests chart](img/azure-lab1/lab1-dynamic-requests-chart.png)
        - On this page you can view the top web requests by count.  You should recognize the URLs from the sample app!
            ![lab1 top web request list](img/azure-lab1/lab1-top-web-request-list.png)
        - You can also view top web request by Response Time by simply changing the metric to Response Time By clicking on one of the requests.
            ![lab1 resp time filter](img/azure-lab1/lab1-resp-time-filter.png)
...
- Review the Service Flow 
    1. Return to the `frontend` service.  You can use the `breakcrumb` menu as shown below.
        ![lab1 navigate to frontend upd](img/azure-lab1/lab1-navigate-to-frontend-upd.png)
    1. On the `frontend` service page, locate the `Topology` section on the right, and then click the `Service Flow` button. 
        ![lab1 service flow arrow upd](img/azure-lab1/lab1-service-flow-arrow-upd.png)
- Response time perspective
    - You should now be on the **Service flow** page.
    - Right away, we can see how this application is structured:  
        * Frontend calls backend
        * Backend calls database
            ![lab1 service flow](img/azure-lab1/lab1-service-flow.png)
...
- Throughput perspective
    ![lab1 service flow tp](img/azure-lab1/lab1-service-flow-tp.png)
    - Refer to the numbers in the picture above:
        1. The timeframe defaults to 10 minutes but can be adjusted
...
![lab1 trans services db](img/azure-lab1/lab1-trans-services-db.png)
- On the `backend` service, click on the `Analyze Backtrace` button.
![lab1 service backtrace arrow upd](img/azure-lab1/lab1-service-backtrace-arrow-upd.png)
    ...
    📓 If you click on any of the rows in the backtrace, the bottom portion of the page will expand.
        ...
        ![lab1 service backtrace arrows](img/azure-lab1/lab1-service-backtrace-arrows.png) 
...
1.  Navigate to the Database screen
    ...
    ![lab1 pick db upd](img/azure-lab1/lab1-pick-db-upd.png)
...
2. Review the Database screen
    - The sample application uses an [In memory Java relational database](http://hsqldb.org/){target="_blank"}.  On this page you can explore the database process like
        ...
        ![lab1 database upd](img/azure-lab1/lab1-database-upd.png)
...
![lab1 technology demo](img/azure-lab1/lab1-technology-demo.png)
...
- Click on the **Technology and processes** link on the left side menu within Dynatrace to view the technologies that OneAgent was able to automatically discover and instrument.
    ![lab1 technology](img/azure-lab1/lab1-technology.png)
- Make sure your management zone filter is set to `All` so that you see everything
    ![lab1 mz filter off](img/azure-lab1/lab1-mz-filter-off.png)
- In the filter box, type `tag`, choose `stage`, and the value of `production`. It should look like this:
    ![lab1 technology filter](img/azure-lab1/lab1-technology-filter.png)
